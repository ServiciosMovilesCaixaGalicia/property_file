%%%----------------------------------------------------------------------
%%% File    : clike_property_mlex.erl
%%% Author  :  <svg@surnet.ru>
%%% Purpose : Free Radius test grammar
%%% Created : 29 Jul 2002 by  <svg@surnet.ru>
%%%----------------------------------------------------------------------
%%%
%%% $Id: clike_property_mlex.erl,v 1.1.1.1 2002/10/04 00:00:00 svg Exp $
%%%
%%% $Log: clike_property_mlex.erl,v $
